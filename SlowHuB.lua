...
Config = {
    ...
    Aimbot = {Enabled=false, FOVEnabled=false, FOVColor=Color3.fromRGB(80,180,255), FOVSize=250, Target="Head", TeamCheck=false, Smoothness=0.25, AutoShot=false, WallCheck=false, AutoReload=false},
...
-- ═══════════ BORDA DA CÁPSULA (Frame atrás com gradiente) ═══════════
